package stockmarket.coin;

import stockmarket.coin.asset.Symbol;
import stockmarket.coin.config.ExchangeConfig;
...
public class ExchangeApp {
    public static void main(String[] args) {
        ...
        UserService userService = exchangeConfig.userService();
        WalletService walletService = exchangeConfig.walletService();
